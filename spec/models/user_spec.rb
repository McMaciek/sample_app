...
describe User do
	...
	describe "when mail format is invalid" do
		it "should be invalid" do
			adresses = %w[user@foo,bar user_at_foo.org exam.user@foo. foo@bar_baz.com foo@bar+baz.com]
	...
	describe "when mail format is valid" do
		it "should be valid" do
			adresses = %w[user@foo.COM A_US-ER@f.b.org first.last@foo.jp a+b@baz.cn]
	...
	describe "when mail is not unique" do
		before do
